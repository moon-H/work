 ...
 */
@SuppressLint("NewApi")
public class CenterManager2 {
    private final static String TAG = "CenterManager2";
    ...
    public CenterManager2(Context context) {
        mContext = context;
        ...
        mConnectTimer = new CountDownTimer(10000, 100) {
            @Override
    ...
    public class LocalBinder extends Binder {
        public CenterManager2 getService() {
            return CenterManager2.this;
        }
    }
    ...
    ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            Log.d(TAG, "scan data = " + dataStr);
            //            mTempDeviceNumber = Integer.parseInt(dataStr, 16);
            sendBleBroadCast(ACTION_FIND_DEVICE, dataStr);
        }
    ...
    public void startScanLeDevice(final boolean enable) {
        ...
        bleScanFilters.add(new ScanFilter.Builder().setServiceUuid(new ParcelUuid(BleDemoMainActivity.CUSTOM_UUID)).build());
    ...
    public void startScanOldApi() {
        UUID[] uuids = new UUID[]{BleDemoMainActivity.CUSTOM_UUID};
        //        sendBleBroadCast(ACTION_START_SCAN);
        //        stopScanOldApi();
    ...
    private BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice device, final int rssi, final byte[] scanRecord) {
            //            stopScanOldApi();
            sendBleBroadCast(ACTION_FIND_DEVICE, "111111");
