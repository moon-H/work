 ...
 * @date 2014 2014-7-18
 */
public class LoopviewpagerActivity extends Activity implements OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_loopview);
    ...
    private void initUI() {
        ...
        pagerAdapter = new CustompagerAdapter(mViewPagerList);
        mViewPager.setAdapter(pagerAdapter);
        mViewPager.setOnPageChangeListener(this);
        mViewPager.setCurrentItem(mCurrentPagePosition, false);
    }

    private void addTextView(final int pIndex) {
        ...
        textview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "这是第几个页面 = " + (pIndex + 1), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void addPoint(int pIndex) {
        ...
        pointImageView.setBackgroundResource(R.drawable._event);
        if (0 == pIndex) {
