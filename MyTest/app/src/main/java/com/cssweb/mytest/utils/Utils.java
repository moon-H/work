...
public class Utils {
    ...
    public static Bitmap getBitmapFromDiskCach(String cachDir, String fileName) {
        //        Log.d(TAG, "cacheDir = " + cachDir + " fileName = " + fileName);
        ...
        //            Log.d(TAG, "getBitmapFromDiskCach outOfMemoryError = " + outOfMemoryError.getMessage());
        //            System.gc();
    ...
    public static String readFileContent(String strFilePath) {
        Log.d(TAG, "readFileContent filePath =" + strFilePath);
        ...
        if (file.isDirectory()) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "read file content occur an error :: ", e);
                return content;
            } finally {
                try {
                    if (instream != null)
