...
public class ArcProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        paintCap = attributes.getInt(R.styleable.ArcProgress_arc_paint_type, 0);
        isDrawText = attributes.getBoolean(R.styleable.ArcProgress_arc_draw_text, false);

        float arcAngleOffset = attributes.getFloat(R.styleable.ArcProgress_arc_angle_offset, default_arc_angle);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = parseMoney(getProgress());
